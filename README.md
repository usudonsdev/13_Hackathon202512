...
クローンした際に`.env.sample`というファイルができているはずなので、複製して名前を.envにする
でもって.envを開いて`SECRET_KEY=`から始まるところをDiscordの通りに修正する
こんなに回りくどい理由はセキュリティ上publicのgit上に載せられないから


**Dockerコンテナをビルド＆起動する**
    
このコマンドだけでPythonのインストールからライブラリの準備まで全自動で行われます。
...
# ここからセットアップ完了後にやること <br>


**Dockerコンテナをビルド＆起動する** <br>
...
**indent-rainbow:** インデントの色分け <br>
**TODOs:** TODOって書いてコメントアウトすると後で一覧で確認できるから、やり残しとかを書いておくとよい <br>
**GitLens':** Gitのブランチを俯瞰できる。全員の進捗が一目でわかる <br>
**GeminiCodeAssistant:** Geminiのコーディング版　フォルダを丸ごと読んでコメントしてくれる　有能 <br>
(Windsurf) <br>
